...
class Material3ChatUIDemo extends StatefulWidget {
  const Material3ChatUIDemo({super.key});

  @override
  State<Material3ChatUIDemo> createState() => _Material3ChatUIDemoState();
}

class _Material3ChatUIDemoState extends State<Material3ChatUIDemo> {
